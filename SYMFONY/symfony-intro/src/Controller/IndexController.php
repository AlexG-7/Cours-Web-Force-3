...
class IndexController extends AbstractController
{
    ...
    /**
     * Une route avec une aprtie variable (entre accolades)
     * Le $qui en paramètre de la méthode contient la valeur de cette partie variable
     *
     * @Route("/bonjour/{qui}")
     */
    public function bonjour($qui)
    {
        return $this->render('index/bonjour.html.twig',
            // Le tableau en 2ème paramètre de la méthode render()
    ...
    /**
     * La route matche /coucou/UnPrénom et /coucou/UnPrénom-UnNom
     *
    ...
    /**
     * Heure dit forcément être un nombre (\d+ en expression régulière)
     *
    ...
    {
        return $this->render('index/bonsoir.html.twig',
            [
                'heure' => $heure
            ]
        );
