...
export class Tab3Page {
  movies = [
    {
      title: "Le labyrinthe",
      image:
        "https://image.tmdb.org/t/p/w300_and_h450_bestv2/7h9LUexxkTSX9YWSQ88b6PE1JdL.jpg",
      resume:
      ...
      comments: [
        {
          name: "Fred",
          date: "2015-01-05",
          comment: "Très bon scénario !",
          score: 5
        },
        {
          name: "Djoe",
          date: "2014-10-11",
          comment: "Film flippant à souhait, mais on a adoré",
          score: 4
        }
      ]
    },
    {
      ...
      image:
        "https://image.tmdb.org/t/p/w300_and_h450_bestv2/uGntNjUx6YAzbVy7RDgxWnWsdet.jpg",
      resume:
      ...
      comments: [
        {
          ...
          date: "2018-02-17",
          comment:
            "Les acteurs sont excellents mais le scénario est parfois bancal ",
          score: 3
        }
      ]
    },
    {
      title: "Coco",
      image:
        "https://image.tmdb.org/t/p/w300_and_h450_bestv2/8AECsRLEDLoNvZ8JqrTFm0zBPqH.jpg",
      resume:
      ...
      comments: [
        {
          ...
          date: "2017-12-15",
          comment:
            "Tout simplement génial pour les enfants. Le thème de la mort dans ce dessin animé est parfaitement abordé. Des images à couper le souffle. Disney quoi",
          score: 5
        },
        {
          name: "Delphine",
    ...
    },
    {
      ...
      image:
        "https://image.tmdb.org/t/p/w300_and_h450_bestv2/c8lQpZWiRgv671BPu9bgzuFkveC.jpg",
      resume:
      ...
      comments: [
        ...
        },
        {
          ...
          date: "2018-03-11",
          comment:
            "Film fantastique sympa mais qui ne restera pas dans l'histoire",
          score: 3
        }
      ]
    },
    {
      title: "Black Panther",
      image:
        "https://image.tmdb.org/t/p/w300_and_h450_bestv2/g94IcdzPswTYl1ISdgn2EwvaZtt.jpg",
      resume:
      ...
      comments: [
        {
          name: "Jennifer",
          date: "2018-02-21",
          comment: "Un Marvel original et frais qui renouvelle le genre",
          score: 5
        },
        {
          name: "Ludo",
          date: "2018-02-28",
          comment:
            "Des scènes d'action à couper le souffle, un monde fantastique loin de toute civilisation et une morale positive, un bon Marvel Americain quoi :)",
          score: 4
        },
        {
          name: "Fred",
          date: "2018-03-01",
          comment: "Juste génialissime !",
          score: 5
        }
      ]
    },

    {
      title: "Ca",
      image:
        "https://image.tmdb.org/t/p/w300_and_h450_bestv2/3SUz0F0I2Bodcj9Ev2pYSWnE9zp.jpg",
      resume:
        'À Derry, dans le Maine, sept gamins ayant du mal à s\'intégrer se sont regroupés au sein du "Club des Ratés". Rejetés par leurs camarades, ils sont les cibles favorites…',
      duration: 135,
      ...
      comments: [
        {
          ...
          date: "2017-10-15",
          comment:
            "Excellent pour jouer à se faire peur, mais attention, n'emmener surtout pas vos enfants au risque de les traumatiser à jamais des clowns :)",
          score: 3
        }
      ]
    },

    {
      ...
      image:
        "https://image.tmdb.org/t/p/w300_and_h450_bestv2/7jAXeNgTPUY00txdsc5JloGCMBN.jpg",
      resume:
...

    {
      title: "Paddington 2",
      image:
        "https://image.tmdb.org/t/p/w300_and_h450_bestv2/qXFEXAJq1gnF9A7wFbTu1OlgSOn.jpg",
      resume:
    ...
    },
    {
      title: "Daddy Cool",
      image:
        "https://image.tmdb.org/t/p/w300_and_h450_bestv2/hrvJ9udxSMSy3GhJeDWuYTZB93x.jpg",
      resume:
    ...
    },
    {
      ...
      image:
        "https://image.tmdb.org/t/p/w300_and_h450_bestv2/c0jCZGc0XMW1TpRP2nRCrwY3Tex.jpg",
      resume:
    ...
    },
    {
      ...
      image:
        "https://image.tmdb.org/t/p/w300_and_h450_bestv2/4Ar01t6sW1ZZBcbz2R1wqjzIBdr.jpg",
      resume:
  ...
  showDetail(movie) {
    this.movieService.push("/detail", movie)
